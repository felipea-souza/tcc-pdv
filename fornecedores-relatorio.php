  ...
  <body>
    <div id="interface">
      ...
      <?php
        ...
        echo "<ul id='alinhar'><li><form id='busca' action='./fornecedores-relatorio.php' method='get'>
              ...
              if (isAdmin()) {
                echo "<li><a href='./fornecedores.php' title='Adicionar novo produto'><img id='adicionar' src='./_imagens/adicionar.png'/></a></li>";
              }
              echo "</ul>";

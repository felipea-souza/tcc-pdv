...
<html lang="pt-br">
  ...
  <body>
    <?php 
      $nome_pag = "Relatório de Produtos de Compras";
      $icone_pag = "documento.png";
      $iconeMouseOut = "documento.png";
      $bread_crumb = "Página Inicial > Relatórios > Relatório de Produtos de Compras";
    ...
    <div id="interface">
      ...
      <div id="alinhar">
        <form action="./produtos-compras-relatorio.php" method="get">
          ...
          Ordenar: 
          <a href="./produtos-compras-relatorio.php?o=cb&cBusca=<?php echo $chave ?>">Cód. Barra</a> |
          <a href="./produtos-compras-relatorio.php?o=prd&cBusca=<?php echo $chave ?>">Produto</a> | 
          <a href="./produtos-compras-relatorio.php?o=lt&cBusca=<?php echo $chave ?>">Lote</a> | 
          <a href="./produtos-compras-relatorio.php?o=meq&cBusca=<?php echo $chave ?>">Menor quant.</a> |
          <a href="./produtos-compras-relatorio.php?o=maq&cBusca=<?php echo $chave ?>">Maior quant.</a> |
          <a href="./produtos-compras-relatorio.php?o=mep&cBusca=<?php echo $chave ?>">Menor Preço</a> |
          <a href="./produtos-compras-relatorio.php?o=map&cBusca=<?php echo $chave ?>">Maior Preço</a> |
          <a href="./produtos-compras-relatorio.php?o=nf&cBusca=<?php echo $chave ?>">Nota Fiscal</a>
        </form>
      ...
      <table class="busca">
        <?php
          ...
          if(!empty($chave)) {
            $query .= " WHERE produtos_compra.cod_barra LIKE '%$chave%' OR produto LIKE '%$chave%' OR lote LIKE '%$chave%' OR quant LIKE '%$chave%' OR produtos_compra.preco LIKE '%$chave%' OR nf_compra LIKE '%$chave%'";
          }
